...
Para detalhes de implantação (Docker, Kubernetes, healthchecks), veja [deploy/DEPLOY.md](deploy/DEPLOY.md). Para política de segurança e API key, veja [SECURITY.md](../SECURITY.md).
