...
- **Static analysis:** `sonar.python.version` in `sonar-project.properties` is **3.12** (single value for Sonar’s Python analyzer).
...
- **Docker Hub:** [hub.docker.com/r/fabioleitao/data_boar](https://hub.docker.com/r/fabioleitao/data_boar) — `fabioleitao/data_boar:latest` and `fabioleitao/data_boar:1.6.7`
