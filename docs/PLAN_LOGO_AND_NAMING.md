...
- **Mascot assets:** [api/static/mascot/](../api/static/mascot/) contains the Data Boar mascot (color and B&W, SVG and PNG, translucent and full backgrounds). Used in base.html (favicon), about.html, dashboard.html, reports.html, **config.html**, **help.html**, and README (EN/pt-BR). See [api/static/mascot/README.md](../api/static/mascot/README.md) for which file to use where.
...
- Web logo: mascot SVG/PNG in `api/static/mascot/` (see [api/static/mascot/README.md](../api/static/mascot/README.md)).
