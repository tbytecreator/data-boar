...
```bash
docker build -t fabioleitao/data_boar:latest -t fabioleitao/data_boar:1.6.4 .
docker login
docker push fabioleitao/data_boar:latest
docker push fabioleitao/data_boar:1.6.4
```
...
1. **Inventário:** No [Docker Hub](https://hub.docker.com/r/fabioleitao/data_boar/tags), liste as tags; anote o que CI, parceiros ou docs fixam (ex.: `latest`, `1.6.4`).
