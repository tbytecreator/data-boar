# Narrativa e histórico de arquitetura (placeholder)

**English:** [NARRATIVE_AND_ARCHITECTURE_HISTORY.md](NARRATIVE_AND_ARCHITECTURE_HISTORY.md)

## Objetivo

Este arquivo fica reservado como **único lugar curado** para:
...
**⬜ Conteúdo ainda não incorporado.** O operador pretende fornecer material depois (export de blog antigo, linha do tempo ou notas ditadas).

## Lembrete para colaboradores e assistentes de IA

Ao expandir **onboarding**, narrativa para **parceiros** ou **contexto de roadmap**, **peça ao operador** material de narrativa/arquitetura para editar neste documento. Não invente histórico detalhado sem esse insumo.

Opcional: rascunhos **brutos** ou exportações longas em `docs/private/` (**ignorado pelo git**; ver [PRIVATE_OPERATOR_NOTES.pt_BR.md](PRIVATE_OPERATOR_NOTES.pt_BR.md)), depois resuma aqui para o repositório público.
