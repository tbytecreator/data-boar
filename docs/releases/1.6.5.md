...
- **Docs:** USAGE (EN + pt-BR) updated for the above; operator notifications cross-links refreshed (TECH_GUIDE, OPERATOR_NOTIFICATION_CHANNELS) for scan-complete webhooks Phase 4.4 partial ✅.
