...
| **test_readme_stakeholder_pitch_contract.py** | Bloco executivo do README (antes de **Visão técnica** / **Technical overview**) mantém os títulos **Farejando com critério** / **Sniffing with judgment** e exclui rótulos só-deck **Data Sniffing** / **Deep Boring** — [ADR 0035](../docs/adr/0035-readme-stakeholder-pitch-vs-deck-vocabulary.md) (texto canônico em inglês).                         |
| **test_about_version_matches_pyproject.py**   | Metadados de versão alinhados ao `pyproject.toml`; **User-Agent** HTTP de saída **`DataBoar-Prospector/<versão>`** — [ADR 0034](../docs/adr/0034-outbound-http-user-agent-data-boar-prospector.md) (texto canônico em inglês).                                                                                                                            |
