...
| **test_readme_stakeholder_pitch_contract.py** | README stakeholder block (before **Technical overview** / **Visão técnica**) keeps **Sniffing with judgment** / **Farejando com critério** headings and excludes deck-only labels **Data Sniffing** / **Deep Boring** — [ADR 0035](../docs/adr/0035-readme-stakeholder-pitch-vs-deck-vocabulary.md).                                      |
| **test_about_version_matches_pyproject.py**   | Version metadata matches `pyproject.toml`; outbound HTTP **User-Agent** is **`DataBoar-Prospector/<version>`** — [ADR 0034](../docs/adr/0034-outbound-http-user-agent-data-boar-prospector.md).                                                                                                                                         |
...
- **test_readme_stakeholder_pitch_contract.py** – Guards the README executive pitch against internal deck vocabulary drift ([ADR 0035](../docs/adr/0035-readme-stakeholder-pitch-vs-deck-vocabulary.md)).
- **test_about_version_matches_pyproject.py** – Version alignment plus outbound **`DataBoar-Prospector/<version>`** User-Agent ([ADR 0034](../docs/adr/0034-outbound-http-user-agent-data-boar-prospector.md)).
