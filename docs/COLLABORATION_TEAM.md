# Team collaboration (Cursor + Git)

**Português (Brasil):** [COLLABORATION_TEAM.pt_BR.md](COLLABORATION_TEAM.pt_BR.md) — **full guide** (fork vs single repo, Git commands, Cursor prompts, rules).
...
| 2026-03-27 | Pointer to talent pool learning paths (archetypes). |
