...
For deployment details (Docker, Kubernetes, healthchecks), see [deploy/DEPLOY.md](deploy/DEPLOY.md). For security policy and API key, see [SECURITY.md](../SECURITY.md). For **sprints**, milestone **M-OBS**, and **error-budget** style guardrails in workflow, see [plans/SPRINTS_AND_MILESTONES.md](plans/SPRINTS_AND_MILESTONES.md) ([pt-BR](plans/SPRINTS_AND_MILESTONES.pt_BR.md)).
