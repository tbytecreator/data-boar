...
For deployment details (Docker, Kubernetes, healthchecks), see [deploy/DEPLOY.md](deploy/DEPLOY.md). For security policy and API key, see [SECURITY.md](../SECURITY.md).
