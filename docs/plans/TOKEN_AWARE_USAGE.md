...
| --------| ----- | --------------- |
| **Short (this cycle)** | High-value slices: maintenance (–1/–1b), **home lab –1L** (manual, after maintenance), FN reduction slice 3 (fuzzy), Strong crypto Phase 1, Data source inventory Phase 1, Notifications Phase 1; content-type optional follow-ups. **If critical:** Priority band A first. | PLANS_TODO § “Priority band A”, § “What to start next” (**–1L**), § “A. Near-term focus” |
