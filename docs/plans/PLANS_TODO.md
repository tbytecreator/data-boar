...
- **Next patch version:** **`1.6.9`** after the next shipped bundle (current published line is **1.6.8** on GitHub + Hub; follow **`docs/releases/`** + VERSIONING checklist).
...
| Doc snapshot per release                             | ✅ Baseline                     | `docs/releases/X.Y.Z.md` per version; **latest published: 1.6.8** (`docs/releases/1.6.8.md`, GitHub + Hub **2026-04-02**); next in-repo bump when ready: **1.6.9**. Optional “frozen bundle” → backlog.                                                                                                                   |
