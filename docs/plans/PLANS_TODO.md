...
- **Maturity self-assessment / LGPD questionnaire (operator artefacts → product backlog):** Under consideration — [PLAN_MATURITY_SELF_ASSESSMENT_GRC_QUESTIONNAIRE.md](PLAN_MATURITY_SELF_ASSESSMENT_GRC_QUESTIONNAIRE.md) — **not** in active code yet; **M-LOCALE-V1** ✅ on **`main`** (**2026-04**); **GRC POC scaffolding** is the **next** primary `feature` candidate when scheduled (option **A** first, then **B → C → D** per plan). Private: `docs/private/raw_pastes/general/LGPD_DOCS/`. **Commercial / subscription** feature—not open core.
...
| Dashboard i18n                                 | **D-WEB** ✅; **M-LOCALE-V1** ✅ on **`main`** (**2026-04**)                                                                                    | None           | **#86** Phase 1 next (session/passwordless on **`/{locale}/…`**). Optional **M-LOCALE-PLUS** (`es`/`fr`/…) + gettext backlog — [PLAN_DASHBOARD_I18N.md](PLAN_DASHBOARD_I18N.md). |
...
1. **Dashboard i18n** – **M-LOCALE-V1** ✅ on **`main`** (**2026-04**); **D-WEB** ✅. **Next:** [#86](https://github.com/FabioLeitao/data-boar/issues/86) **Phase 1** (session/passwordless on **`/{locale}/…`**). Coordinate **#86** with [PLAN_DASHBOARD_I18N.md](PLAN_DASHBOARD_I18N.md).
