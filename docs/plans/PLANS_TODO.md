...
| Additional data soup formats                   | Optional: Compressed, content-type                                                                                                    | None           | **Tier 3 rich media** ✅ on **`main`**; **Tier 1** + **opt-in stego hints** ✅ on **`main`** (`[dataformats]` optional); **Tier 3b** still backlog. See PLAN_ADDITIONAL_DATA_SOUP_FORMATS + **Integration / WIP**.                                                         |
