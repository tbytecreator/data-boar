...
### Integration / WIP — last refreshed **2026-03-31**
...
- **Next patch version:** **`1.6.8`** after the next shipped bundle (current published line is **1.6.7** on GitHub + Hub; follow **`docs/releases/`** + VERSIONING checklist).
...
| Doc snapshot per release                             | ✅ Baseline                     | `docs/releases/X.Y.Z.md` per version; **latest published: 1.6.7** (`docs/releases/1.6.7.md`, GitHub + Hub **2026-03-26**); next in-repo bump when ready: **1.6.8**. Optional “frozen bundle” → backlog.                                                                                                                   |
