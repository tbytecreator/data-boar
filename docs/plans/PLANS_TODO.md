...
- **Status rows counted:** 152  (Done: 87 | Incomplete: 65)
...
- **WebAuthn JSON endpoints** and cookie helpers do **not** complete in-app **RBAC** or HTML dashboard gating until **#86** later phases ship; challenge store remains **in-process** unless a plan adds shared state (see ADR 0033).
