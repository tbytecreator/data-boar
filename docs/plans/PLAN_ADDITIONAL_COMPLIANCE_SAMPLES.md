...
| **2. Documentation**  |                                                                                                                                                                                                                                                                                                                                                                                                                                                           |           |
| 2.1                   | **Pitch (README):** In the “For decision-makers” or “Technical overview” section, add one short sentence: e.g. “Sample configs for **UK GDPR**, **PIPEDA**, **POPIA**, **APPI**, and **PCI-DSS** are available in [docs/compliance-samples](docs/compliance-samples/) (see [compliance-frameworks](docs/COMPLIANCE_FRAMEWORKS.md)).” Same in README.pt_BR.md.                                                                                             | ⬜ Pending |
