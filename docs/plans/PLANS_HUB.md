...
| **Open** | [PLAN_FOUNDER_CAREER_AND_BRANDING.pt_BR.md](PLAN_FOUNDER_CAREER_AND_BRANDING.pt_BR.md) | Untitled | Plano privado do operador - detalhes de carreira, branding e presenca digital. Documento completo em docs/private/ (gitignored). | — |
