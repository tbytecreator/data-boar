...
| **Rio Brasil Terminal (ICTSI Group) – Destaque do Semestre 2023.1 – TI**                                         | Employer **recognition** (“Highlight of the Semester”) for **Information Technology**, semester **2023.1**. Supports leadership / impact narrative alongside security ops. **Private:** keep scan or photo only under `docs/private/` (e.g. `RioBrasil_Terminal_destaque_2023_1_TI.pdf`); **do not** commit OneDrive paths or full personal-ID pages. |
| **ICTSI LMS – Protect Yourself from Ransomware (with Quiz)**                                                     | Completed **2023-05-04**; security **awareness** / ransomware basics via employer LMS. **Private:** PDF copy under `docs/private/` only (e.g. `ICTSI_LMS_Ransomware_2023.pdf`); original may stay on employer storage. |
| **ICTSI LMS – Treinamento ISPS Code 18.3b**                                                                    | Completed **2025-05-23**; **~1 h** stated workload; **ISPS** (maritime / port facility security) alignment with terminal operations context. **Private:** PDF under `docs/private/` only (e.g. `ICTSI_LMS_ISPS_Code_18_3b_2025.pdf`). |
