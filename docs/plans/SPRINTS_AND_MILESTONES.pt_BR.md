...
**Planos:** [PLAN_DASHBOARD_I18N.md](PLAN_DASHBOARD_I18N.md), [PLAN_DASHBOARD_REPORTS_ACCESS_CONTROL.md](PLAN_DASHBOARD_REPORTS_ACCESS_CONTROL.md) e [PLAN_DASHBOARD_MOBILE_RESPONSIVE.md](PLAN_DASHBOARD_MOBILE_RESPONSIVE.md) (layout responsivo — **ortogonal** ao idioma). Mesmos arquivos (`api/routes.py`, templates, CSS/JS estático, middleware); **critérios de aceite distintos** (língua vs autorização vs viewport).
...
| ----- | ----                                  | ---- | -----                                                                                                                                                                                             |
| 0     | **M-MOBILE-V1** (opcional)            | A    | Nav + tabelas + gráfico responsivos — [PLAN_DASHBOARD_MOBILE_RESPONSIVE.md](PLAN_DASHBOARD_MOBILE_RESPONSIVE.md). **Antes** ou **em paralelo** à linha 1 se o operador priorizar operadores em telefone/tablet. |
