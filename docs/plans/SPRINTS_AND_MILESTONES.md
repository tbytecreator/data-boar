...
**Plans:** [PLAN_DASHBOARD_I18N.md](PLAN_DASHBOARD_I18N.md), [PLAN_DASHBOARD_REPORTS_ACCESS_CONTROL.md](PLAN_DASHBOARD_REPORTS_ACCESS_CONTROL.md), and [PLAN_DASHBOARD_MOBILE_RESPONSIVE.md](PLAN_DASHBOARD_MOBILE_RESPONSIVE.md) (responsive layout — **orthogonal** to locale). Same files (`api/routes.py`, templates, static CSS/JS, middleware); **separate acceptance criteria** (language vs authorization vs viewport).
