...
| **Preparação 1.6.9 + portões Wabbix (Dependabot → CodeQL → Sonar? → Scout → check-all)** | [OPERATOR_TODAY_MODE_2026-04-16.pt_BR.md](OPERATOR_TODAY_MODE_2026-04-16.pt_BR.md) | ⬜ Substituído pela frente 1.7.0 | Linha antiga — fechar quando **2026-04-17** estiver ok; **Wabbix** segue [WABBIX_REVIEW_REQUEST_GUIDELINE.md](../WABBIX_REVIEW_REQUEST_GUIDELINE.md) |
