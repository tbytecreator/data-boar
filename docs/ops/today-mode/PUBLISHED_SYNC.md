...
| ----- | ----- |
| **Verified** | **2026-03-31** |
| **`pyproject.toml` on `main`** | **1.6.7** |
| **GitHub Release Latest** | [**v1.6.7**](https://github.com/FabioLeitao/data-boar/releases/tag/v1.6.7) (published **2026-03-26**) |
| **Docker Hub** | **`fabioleitao/data_boar:1.6.7`** + **`latest`** (pushed **2026-03-26**) |
| **Next public version** (when `main` has a new bundle) | **1.6.8** — follow **`docs/VERSIONING.md`** + **`docs/releases/`** |
...
Docker Hub: confirm **`1.6.7`** and **`latest`** on [hub.docker.com/r/fabioleitao/data_boar/tags](https://hub.docker.com/r/fabioleitao/data_boar/tags) or the Registry API.
