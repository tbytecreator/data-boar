...
Short, durable notes that capture **why** the project chose an approach—not only *what* the code does. They complement [plans](../plans/PLANS_TODO.md) (backlog and execution) and [TESTING.md](../TESTING.md) (what CI enforces).
