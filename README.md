...
| **`pip` from PyPI** (legacy package id)                           | **`pip install python3-lgpd-crawler`** installs this product; the public name is **Data Boar** — see [CONTRIBUTING.md — Repository and install identity](CONTRIBUTING.md#repository-and-install-identity-data-boar).                          |
