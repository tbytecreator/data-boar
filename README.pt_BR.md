...
- **pip via PyPI** (id de pacote legado): **`pip install python3-lgpd-crawler`** instala este produto; o nome público é **Data Boar** — veja [CONTRIBUTING.pt_BR.md — Repositório e identidade](CONTRIBUTING.pt_BR.md#repositório-e-identidade-de-instalação-data-boar).
