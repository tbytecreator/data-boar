...
> **Release atual:** 1.7.1. Resumo: [CHANGELOG.md](CHANGELOG.md). Notas completas: [docs/releases/](docs/releases/) e a [página de Releases no GitHub](https://github.com/FabioLeitao/data-boar/releases).
