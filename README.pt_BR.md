...
**Saúde nos EUA (HIPAA / HITECH / H.R. 7898):** A linguagem **HIPAA** embutida apoia **inventário técnico** de possível exposição de **PHI/ePHI** — **não** análise automática de **violação (breach HIPAA)**, contagem de pessoas para notificação, fluxos de resposta a **HHS/OCR** nem certificação de **safe harbor** / **recognized security practices** sob a **P.L. 116-321**. Veja [Conformidade e jurídico](docs/COMPLIANCE_AND_LEGAL.pt_BR.md) para alcance e limites.
...
**Roadmap:** Seguimos ampliando a **descoberta** (arquivos e mídia mais ricos, conectores em **nuvem** e **enterprise**), melhorando **alertas** ao fim da varredura e mantendo **segurança e dependências** em dia. A **cobertura de idiomas** na interface e na documentação, e as **amostras regionais** de conformidade, crescem **aos poucos**, conforme a demanda — não todos os mercados de uma vez. **Para conselho e auditoria:** a narrativa permanece **legível para executivos** — dá para apontar **direção e evidências** sobre visibilidade de dados e postura de conformidade sem pedir que stakeholders mergulhem num roadmap só de engenharia. Para normas (ex.: ISO 27701, SOC 2), perfis de amostra sobre **menores**, planos de SBOM, sinais de saúde da API e o que já está entregue vs em fases, veja **[Conformidade e jurídico](docs/COMPLIANCE_AND_LEGAL.pt_BR.md)** e **[docs/releases/](docs/releases/)** — o detalhe fica ali para esta seção continuar legível para compras e jurídico.
